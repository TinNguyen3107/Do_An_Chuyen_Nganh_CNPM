    ...
    <div className="animate-fade-in max-w-6xl">
        ...
        {loading ? (
          <div className="space-y-4">
            {[...Array(3)].map((_, i) => (
              <div
                key={i}
                className="flex gap-4 p-4 bg-slate-800/50 rounded-xl animate-pulse"
              >
            ...
            {enrollments.slice(0, 5).map((enrollment) => {
              ...
              return (
                <Link
                  ...
                  className="flex gap-4 p-4 bg-slate-800/50 hover:bg-slate-800 border border-transparent hover:border-slate-700 rounded-xl transition-all group"
                >
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Link
            to="/courses"
            className="flex items-center gap-3 p-4 bg-slate-800 hover:bg-slate-700 rounded-xl border border-slate-700 hover:border-slate-600 transition-all group"
          >
            <div className="w-10 h-10 rounded-xl bg-blue-600/20 flex items-center justify-center text-xl">
              🔍
            </div>
            <div>
